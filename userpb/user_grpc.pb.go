...
type UserServiceClient interface {
	...
	WatchUsers(ctx context.Context, in *UserRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[UserResponse], error)
}
...
func (c *userServiceClient) WatchUsers(ctx context.Context, in *UserRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[UserResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type UserServiceServer interface {
	...
	WatchUsers(*UserRequest, grpc.ServerStreamingServer[UserResponse]) error
...
func (UnimplementedUserServiceServer) WatchUsers(*UserRequest, grpc.ServerStreamingServer[UserResponse]) error {
...
func _UserService_WatchUsers_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(UserServiceServer).WatchUsers(m, &grpc.GenericServerStream[UserRequest, UserResponse]{ServerStream: stream})
}
